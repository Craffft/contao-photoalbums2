...
$GLOBALS['TL_LANG']['tl_module']['pa2AlbumsImageSize'] = array('Albenansicht Bildbreite und Bildhöhe', 'Hier können Sie die Abmessungen des Bildes und den Skalierungsmodus festlegen.');
$GLOBALS['TL_LANG']['tl_module']['pa2PhotosImageSize'] = array('Fotoansicht Bildbreite und Bildhöhe', 'Hier können Sie die Abmessungen des Bildes und den Skalierungsmodus festlegen.');
$GLOBALS['TL_LANG']['tl_module']['pa2AlbumsImageMargin'] = array('Albenansicht Bildabstand', 'Hier können Sie den oberen, rechten, unteren und linken Bildabstand eingeben.');
$GLOBALS['TL_LANG']['tl_module']['pa2PhotosImageMargin'] = array('Fotoansicht Bildabstand', 'Hier können Sie den oberen, rechten, unteren und linken Bildabstand eingeben.');
...
$GLOBALS['TL_LANG']['tl_module']['pa2AlbumsMetaFields'] = array('Albenansicht Meta Felder', 'Bitte wählen Sie die Meta Felder aus, die in der Albenansicht ausgegeben werden sollen.');
$GLOBALS['TL_LANG']['tl_module']['pa2PhotosMetaFields'] = array('Fotoansicht Meta Felder', 'Bitte wählen Sie die Meta Felder aus, die in der Fotoansicht ausgegeben werden sollen.');
