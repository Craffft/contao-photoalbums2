...
$GLOBALS['TL_LANG']['tl_module']['pa2OverviewPage']              = array('Alben-Übersicht Seite', 'Wählen Sie die Alben-Übersicht Seite aus, in der Sie dieses Modul einbinden.');
...
$GLOBALS['TL_LANG']['tl_module']['pa2AlbumsTemplate']            = array('Alben-Element Template', 'Wählen Sie hier das Template für das Alben-Element aus. Dieses wird innerhalb der Alben-Übersicht für jedes Album verwendet.');
...
$GLOBALS['TL_LANG']['tl_module']['pa2AlbumsShowHeadline']        = array('Modul Überschrift in Alben-Übersicht anzeigen', 'Setzen Sie dieses Häkchen, um die Modul Überschrift in der Alben-Übersicht anzuzeigen.');
...
$GLOBALS['TL_LANG']['tl_module']['pa2AlbumsShowTitle']           = array('Alben Titel in Alben-Übersicht anzeigen', 'Setzen Sie dieses Häkchen, um den Titel der Alben in der Alben-Übersicht anzuzeigen.');
...
$GLOBALS['TL_LANG']['tl_module']['pa2AlbumsShowTeaser']          = array('Teaser in Alben-Übersicht anzeigen', 'Setzen Sie dieses Häkchen, um den Teaser in der Alben-Übersicht anzuzeigen.');
...
$GLOBALS['TL_LANG']['tl_module']['pa2AlbumsImageSize']           = array('Alben-Übersicht Bildbreite und Bildhöhe', 'Hier können Sie die Abmessungen des Bildes und den Skalierungsmodus festlegen.');
...
$GLOBALS['TL_LANG']['tl_module']['pa2AlbumsImageMargin']         = array('Alben-Übersicht Bildabstand', 'Hier können Sie den oberen, rechten, unteren und linken Bildabstand eingeben.');
...
$GLOBALS['TL_LANG']['tl_module']['pa2AlbumsShowMetaDescriptions'] = array('Meta Beschreibungen in Alben-Übersicht anzeigen', 'Setzen Sie dieses Häkchen, um die Beschreibungen der Meta-Felder in der Alben-Übersicht anzuzeigen.');
$GLOBALS['TL_LANG']['tl_module']['pa2AlbumsMetaFields']          = array('Alben-Übersicht Meta Felder', 'Bitte wählen Sie die Meta Felder aus, die in der Alben-Übersicht ausgegeben werden sollen.');
