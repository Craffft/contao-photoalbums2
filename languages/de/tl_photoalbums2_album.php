...
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['previewImageType'] = array('Vorschau Foto', 'Wählen Sie hier, wie das Vorschau Foto angezeigt werden soll.');
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['previewImage'] = array('Vorschau Foto auswählen', 'Wählen Sie hier das Vorschau Foto aus.');
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['imageSortType'] = array('Fotos sortieren', 'Wählen Sie hier, wie die Fotos sortiert werden sollen.');
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['imageSort'] = array('Fotos sortieren', 'Hier können Sie die Fotos sortieren.');
