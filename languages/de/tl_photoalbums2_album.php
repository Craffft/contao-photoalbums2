...
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['preview_pic_check'] = array('Vorschau Foto', 'Wählen Sie hier, wie das Vorschau Foto angezeigt werden soll.');
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['preview_pic'] = array('Vorschau Foto auswählen', 'Wählen Sie hier das Vorschau Foto aus.');
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['pic_sort_check'] = array('Fotos sortieren', 'Wählen Sie hier, wie die Fotos sortiert werden sollen.');
