...
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['preview_image_type'] = array('Preview image', 'Select here to preview how the image will be displayed.');
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['preview_image'] = array('Select image preview', 'Choose here the preview image.');
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['image_sort_type'] = array('Sort images', 'Select how the images will be sorted.');
