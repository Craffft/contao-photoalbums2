...
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['pic_preview'] = array('Preview image', 'Choose here the preview image.');
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['pic_sort_check'] = array('Sort photos', 'Set this checkbox to sort the photos.');
