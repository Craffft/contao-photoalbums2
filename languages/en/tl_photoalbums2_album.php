...
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['previewImage'] = array('Select image preview', 'Choose here the preview image.');
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['imageSortType'] = array('Sort images', 'Select how the images will be sorted.');
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['imageSort'] = array('Sort images', 'Here you can sort the images.');
