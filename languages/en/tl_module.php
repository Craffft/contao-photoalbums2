...
$GLOBALS['TL_LANG']['tl_module']['pa2AlbumsShowMetaDescriptions'] = array('Show meta descriptions in album view', 'Set this checkbox to show the descriptions from the meta fields in the album view.');
